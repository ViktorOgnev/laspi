...
function img_load(){
	...
	img_unsel['item_actions'] =  new Image; img_unsel['item_actions'].src = document.getElementById('item_actions').src;
	...
	img_unsel['item_buy'] =  new Image; img_unsel['item_buy'].src = document.getElementById('item_buy').src;
	
	img_sel['item_uslugi'] = new Image; img_sel['item_uslugi'].src = '/lang/ru/theme/images/menu/item_uslugi_sel.gif';
	img_sel['item_actions'] =  new Image; img_sel['item_actions'].src = '/lang/ru/theme/images/menu/item_actions_sel.gif';
	...
	img_sel['item_buy'] =  new Image; img_sel['item_buy'].src = '/lang/ru/theme/images/menu/item_buy_sel.gif';
