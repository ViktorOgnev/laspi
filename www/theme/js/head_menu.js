...
function img_load(){
	...
	img_sel['item_uslugi'] = new Image; img_sel['item_uslugi'].src = '/theme/images/menu/item_uslugi_sel.gif';
	img_sel['item_kongress'] =  new Image; img_sel['item_kongress'].src = '/theme/images/menu/item_kongress_sel.gif';
	img_sel['item_turagent'] =  new Image; img_sel['item_turagent'].src = '/theme/images/menu/item_turagent_sel.gif';
	img_sel['item_onas'] =  new Image; img_sel['item_onas'].src = '/theme/images/menu/item_onas_sel.gif';
	img_sel['item_turistam'] =  new Image; img_sel['item_turistam'].src = '/theme/images/menu/item_turistam_sel.gif';
	img_sel['item_det'] =  new Image; img_sel['item_det'].src = '/theme/images/menu/item_det_sel.gif';
